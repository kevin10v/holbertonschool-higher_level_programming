...
Flask API with Basic Auth and JWT Auth (with role checks).
"""
...
# Use a strong secret. For CI, any fixed value is fine.
...
@auth.error_handler
def auth_error():
    # Ensure 401 on any Basic Auth failure
...
# ---- JWT error handlers: always return 401 on auth failures --------------
